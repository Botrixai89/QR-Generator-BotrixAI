...
const svgTemplates: Record<SocialMediaPlatform, string> = {
  ...
  snapchat: `
    <svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
      <rect width="64" height="64" rx="16" fill="#FFFC00"/>
      <path d="M32 12c6 0 10 4.5 10 10.5 0 2.7-.5 5 1.5 7 1.2 1.2 2.6 2 4.3 2.5.8.2 1.3 1.1.8 1.8-1.1 1.7-3 2.7-5 3.3-1 .3-1.7 1.3-1.4 2.3.7 2.5 2.6 4.1 5.5 4.3.9.1 1.5 1 .9 1.7-1.7 2.1-4.4 3.5-7.1 4-1 .2-1.7 1.1-1.6 2.1.2 2.5-1.6 4.7-4.1 5H28c-2.5-.3-4.3-2.5-4.1-5 .1-1- .6-1.9-1.6-2.1-2.7-.5-5.4-1.9-7.1-4-.6-.7 0-1.6.9-1.7 2.9-.2 4.8-1.8 5.5-4.3.3-1-.4-2-1.4-2.3-2-.6-3.9-1.6-5-3.3-.5-.7 0-1.6.8-1.8 1.7-.5 3.1-1.3 4.3-2.5 2-2 1.5-4.3 1.5-7C22 16.5 26 12 32 12z" fill="#000"/>
    </svg>
  `,
  twitter: `
    <svg width="64" height="64" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
