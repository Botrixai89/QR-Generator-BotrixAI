import type { SocialMediaPlatform } from "@/components/social-media-icons"
...
const svgTemplates: Record<SocialMediaPlatform, string> = {
  instagram: `
    <svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="4" y="4" width="56" height="56" rx="16" fill="url(#instaGradient)"/>
      <rect x="16.5" y="16.5" width="31" height="31" rx="10" stroke="white" stroke-width="4" fill="none"/>
  ...
  snapchat: `
    <svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M32 14c-3.5 0-6.3 1.2-8.2 3.5-1.7 2.1-2.3 4.8-2.3 7.5 0 1.2.1 2.5.2 3.8.1.8-.2 1.2-.8 1.4-1.5.5-2.8 1-3.5 1.3-.5.2-.7.5-.7.9 0 .5.4.9 1.1 1.1.3.1.7.1 1.1.2 1.4.2 3.2.5 4 1.8.3.5.4 1 .3 1.6-.4 1.8-.9 3.5-1.3 4.5-.2.4-.1.8.2 1.1.3.3.7.4 1.1.3 1.2-.3 2.5-.9 4.2-.9 1.3 0 2.4.4 3.7.9 1.6.6 3.4 1.3 5.9 1.3 2.5 0 4.3-.7 5.9-1.3 1.3-.5 2.4-.9 3.7-.9 1.7 0 3 .6 4.2.9.4.1.8 0 1.1-.3.3-.3.4-.7.2-1.1-.4-1-.9-2.7-1.3-4.5-.1-.6 0-1.1.3-1.6.8-1.3 2.6-1.6 4-1.8.4-.1.8-.1 1.1-.2.7-.2 1.1-.6 1.1-1.1 0-.4-.2-.7-.7-.9-.7-.3-2-.8-3.5-1.3-.6-.2-.9-.6-.8-1.4.1-1.3.2-2.6.2-3.8 0-2.7-.6-5.4-2.3-7.5C38.3 15.2 35.5 14 32 14z" fill="#000"/>
    </svg>
  `,
  twitter: `
    <svg width="64" height="64" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
const encodeSvg = (svg: string): string => {
  ...
  return `data:image/svg+xml;base64,${Buffer.from(normalized, "utf-8").toString("base64")}`
}
...
export const isSocialMediaTemplate = (template?: string | null): template is SocialMediaPlatform => {
  if (!template) return false
  return SOCIAL_MEDIA_PLATFORMS.includes(template as SocialMediaPlatform)
}
