...
const blogPosts: BlogPost[] = [
  {
    slug: 'how-to-create-upi-qr-code-free',
    title: 'How to Create UPI QR Code for Free in 2025 - Complete Guide',
    description: 'Learn how to create free UPI QR codes for payments. Step-by-step guide for Google Pay, PhonePe, Paytm, and BHIM.',
    date: '2025-11-27',
    readTime: '7 min',
    category: 'Tutorial',
    featured: true,
  ...
  {
    slug: 'free-qr-code-generator-with-logo',
    title: 'Free QR Code Generator with Logo - Add Your Brand in 2025',
    description: 'Create professional QR codes with your logo for free. Step-by-step guide to add custom logos and branding.',
    date: '2025-11-26',
    readTime: '6 min',
    category: 'Tutorial',
    featured: true,
  },
  {
    ...
    description: 'Learn how to create and use QR codes on business cards. Best practices, design tips, and what to include.',
    date: '2025-11-25',
    readTime: '5 min',
    category: 'Business',
  },
  {
    ...
    description: 'Understand the differences between dynamic and static QR codes and when to use each type.',
    date: '2025-11-24',
    readTime: '4 min',
    category: 'Guide',
  },
  {
    ...
    description: 'Learn the optimal QR code sizes for business cards, posters, packaging, and digital displays.',
    date: '2025-11-23',
    readTime: '4 min',
    category: 'Guide',
  },
